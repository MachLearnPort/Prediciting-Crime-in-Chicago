...
filenameA=[PW,'Predictions\pred.csv']; %file dir of attrition prediction

% Import prediction CSV
[A_pred,~]=csv2struct(filenameA);

A=A_pred.X1; %Extract yes prediction probability from A_pred structure
